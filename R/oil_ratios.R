...
#' 
#' \code{oil_ratios} is useful for 2-stroke fuel-oil mixing. 
#' 
...
#' 
#' @return Data frame with metric units. 
#' 
#' @examples 
#' \dontrun{
#' 
...
#' 
#' @export
oil_ratios <- function(ratio, volume_fuel = NA) {
  
  if (class(ratio) %in% c("integer", "numeric")) 
    stop("'ratio' should be a string, for example, '50:1'.", call. = FALSE)
