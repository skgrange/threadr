...
#' data frame. 
#' 
#' tabuliseFileMetadata uses Phil Harvey's Perl \code{exiftool} to extract a 
...
#' implemented on Windows or OS X and therefore I cannot guarentee that this 
#' function will work on such systems. 
#' 
#' tabuliseFileMetadata can be useful for media files and the exploration of 
#' metadata. 
#' 
...
#' @export
#'
tabuliseFileMetadata <- function (file = '15 Technologue.mp3') {
